<#assign menu="headline"> <#assign submenu="update_folder"> <#include
"/manage/head.ftl">
<!--main content start-->
	              ...
	              <div class="panel-body">
	                  <form id="update_headline_form" method="post" class="form-horizontal" autocomplete="off" action="${BASE_PATH}/manage/headline/update.json"
	                      ...
	                      <div class="form-group">
	                          ...
	                          <div class="col-sm-10">
	                              <input type="text" style="font-size:15px;width: 600px;" class="form-control" name="description" value="${headline.description}" placeholder="头图描述">
	                          </div>
	                      </div>
	                      <div class="form-group">
