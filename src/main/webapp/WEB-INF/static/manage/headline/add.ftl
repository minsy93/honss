                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                            	 添加头图（电脑版尺寸：宽${width_pc}px，高${height_pc}px  ipad版尺寸：宽${width_ipad}px，高${height_ipad}px）
                          </header>
                          <div class="panel-body">
                              <form id="addFolder_form" method="post" class="form-horizontal" autocomplete="off" action="${BASE_PATH}/manage/headline/add.json"
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">头图描述</label>
                                      <div class="col-sm-10">
                                          <input type="text" style="font-size:15px;width: 600px;" class="form-control" name="description"
                                          	placeholder="头图描述" id="folderName" >
                                          </input>
                                      </div>
                                  </div>
                                  <div class="form-group">
