	...
	<section class="wrapper">
		...
		<div class="row">
			<form id="update_folder_form" method="post"
				...
				action="${BASE_PATH}/manage/folder/update.json" enctype="multipart/form-data">
				<div class="col-lg-12">
					...
					<section class="panel">
						...
						<div class="panel-body">
							<div class="form-group">
	                          ...
	                          <div class="col-sm-10">
	                          	<#if folder.picture??>
	                          		<img src="${BASE_PATH}/${folder.picture}" alt="img04" style="height:120px;">
	                          	</#if>
                        	...
                        	<div class="form-group">
	                          ...
	                          <div class="form-group">
	                              <label class="col-sm-2 col-sm-2 control-label">主打系列</label>
	                              <div class="col-sm-10">
	                              	<label class="radio-inline">
	                            		<input type="radio" class="mainSeries" id="isMainSeries" name="isMainSeries" value="1" <#if folder.isMainSeries==1>checked</#if>/> <label for="isMainSeries">是</label>
	                          		</label>
	                          		<label class="radio-inline">
	                            		<input type="radio" class="mainSeries" id="isNotMainSeries" name="isMainSeries" value="0" <#if folder.isMainSeries==0>checked</#if>/> <label for="isNotMainSeries">否</label>
	                          		</label>
	                              </div>
	                          </div>
	                          <div class="form-group mainSeriesDiv" style="display:none;">
	                          <label class="col-sm-2 col-sm-2 control-label">主打系列封面图片</label>
	                          <div class="col-sm-10">
	                          	<#if folder.mainPicture??>
	                          		<img src="${BASE_PATH}/${folder.mainPicture}" alt="img04" style="height:120px;">
	                          	</#if> 
                          ...
                          <div class="col-sm-10">
                              <input type="text" style="font-size:15px;" class="form-control" name="summary"
                              	placeholder="摘要" id="summary" value="${folder.summary!}">
                              </input>
                          </div>
                        </div>	                        
	                        <div class="form-group">
...
<script type="text/javascript">
	...
	var kind = "folder";	
	$(function() {
		if(${folder.isMainSeries}==1){
			$(".mainSeriesDiv").show();
		}
		$('.mainSeries').click(function(){
			if($(this).val()==1){
				$(".mainSeriesDiv").show();
			}else{
				$(".mainSeriesDiv").hide();
