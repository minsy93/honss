...
<html lang="zh-CN">
    ...
    <script>
		 $(function(){
            ...
            if(wid>768){
                ...
                if($(".index-container-icon1")!=undefined){
                	$(".index-container-icon1").attr("style","left:"+(left+980-84)+"px;");
                }
  ...
  <header class="nav-header">
	  ...
	  <nav class="navbar navbar-default">
		...
		<div class="<#if browerType! == "ie7">index-container-icon1<#else>index-container-icon</#if>">
