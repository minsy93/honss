		...
		<header class="white-bg">
			<div class="container" style="background-color: #ffffff; padding: 10px;">
				...
				<a href="${BASE_PATH}/index.htm" class="logo" title="访问前台页面">
					<img src="${TEMPLATE_BASE_PATH}/image/HONS.png" style="margin-bottom:15px;" />
				</a>
				<!--logo end-->
		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="sub-menu">
						<a href="${BASE_PATH}/manage/headline/list.htm" <#if menu="headline">class="active"</#if>> <i class="icon-desktop"></i> <span>首页头图</span></a>
					</li>
					<li class="">
